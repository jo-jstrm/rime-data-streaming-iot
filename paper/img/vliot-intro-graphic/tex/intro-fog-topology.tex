...
\begin{tikzpicture}[garlic growth=A,mmap/child weight=0,
    ...
    \node[triangle,
        ...
        %label={[xshift=-8.1em, yshift=-6.75em]\circled{E}},
        %label={[xshift=-2.6em, yshift=-1.75em]\circled{G}}
    ] (sink){}
        child [color=Black!80] foreach \A in {0,1,2,3} { node (n\A){}
            child [color=Black!80] foreach \B in {0,1,2} { node (n\A\B){}
                child [color=Black, draw=none] foreach \C in {0,1,2} { node (n\A\B\C){}}
            }
        };
    
    % Change color of the "relevant" edge nodes
    ...
    \begin{scope}[on background layer]  
        ...
        \draw[BrickRed!50,line width=2.2em,line cap=round] (sink.center) -- (n1.center);

        \draw[BrickRed!50,line width=2.2em,line cap=round] (n1) -- (n10.center);
        \draw[BrickRed!50,line width=2.2em,line cap=round] (n10.center) -- (n100.center);
        \draw[BrickRed!50,line width=2.2em,line cap=round] (n10.center) -- (n101.center);
        \draw[BrickRed!50,line width=2.2em,line cap=round] (n10.center) -- (n102.center);

        \draw[BrickRed!50,line width=2.2em,line cap=round] (n1) -- (n11.center);
        \draw[BrickRed!50,line width=2.2em,line cap=round] (n11.center) -- (n111.center);
        \draw[BrickRed!50,line width=2.2em,line cap=round] (n11.center) -- (n112.center);
        \draw[BrickRed!50,line width=2.2em,line cap=round] (n11.center) -- (n110.center);

        \draw[BrickRed!50,line width=2.2em,line cap=round] (n1) -- (n12.center);
        \draw[BrickRed!50,line width=2.2em,line cap=round] (n12.center) -- (n120.center);
        \draw[BrickRed!50,line width=2.2em,line cap=round] (n12.center) -- (n121.center);
        \draw[BrickRed!50,line width=2.2em,line cap=round] (n12.center) -- (n122.center);
                
        
        \draw[PineGreen!60,line width=1.2em,line cap=round] (sink.center) -- (n1.center);        
        \draw[PineGreen!60,line width=1.2em,line cap=round] (n1) -- (n12.center);
        \draw[PineGreen!60,line width=1.2em,line cap=round] (n12.center) -- (n120.center);

        \draw[black!50,dotted, thick] (sink.center) circle[radius=3];
    \end{scope}
    ...
    \begin{customlegend}[
        ...
        legend style={at={(2.75,5)},font=\footnotesize}] % <= to define position and font legend
    ...
    \begin{customlegend}[
        ...
        legend entries={ % <= in the following there are the entries
            Route for answering the query,            
            Probed nodes,            
            Node with relevant data,
            Outer Edge
        },
        legend style={at={(3.9,-4.5)},font=\footnotesize}] % <= to define position and font legend
        % the following are the "images" and numbers in the legend        
        \addlegendimage{shape in legend={draw=none, yshift=0.1em}{PineGreen!60}}        
        \addlegendimage{shape in legend={draw=none, yshift=0.1em}{BrickRed!50}}        
        \addlegendimage{shape in legend={circle, draw=none, yshift=0.1em}{Dandelion}}
        \addlegendimage{Black, very thick, dotted}
    \end{customlegend}      
\end{tikzpicture}
\end{document}